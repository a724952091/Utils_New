...
public class HbaseUtils {
    ...
    static{
        ...
        conf.set("hbase.rootdir","hdfs://192.168.32.200:9000/hbase");
        //使用eclipse时必须添加这个，否则无法定位
        conf.set("hbase.zookeeper.quorum","192.168.32.200");
     ...
     *插入数据
     */
    public static void putdate(String tablename,String rowkey,String famliyname,String colum,String data)throws Exception{
        Table table = conn.getTable(TableName.valueOf(tablename));
